          ...
          <ul class="form-list">
            ...
            <li class="form-list__row form-list__row--inline">
              ...
              <div>
                ...
                <input type="text" name="a5" placeholder="123" pattern="\\d*" minlength="3" maxlength="4" required="" />
              </div>
            </li>
            ...
            <li>
              ...
              <button type="button" onClick="alert('결제완료')" id="card" style="background-color: green; padding: 10px; border: none;">
              <a href="dogorder_ok" style="text-decoration-line: none; color: white;">결제하기</a></button>
              <button type="button" id="close" style="background-color: green; padding: 10px; border: none;">
              <a href="dogorder" style="text-decoration-line: none; color: white;">취소하기</a></button>
            </li>
          </ul>
        </form>
