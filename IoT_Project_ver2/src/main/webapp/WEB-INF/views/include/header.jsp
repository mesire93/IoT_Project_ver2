			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-md-0">
					...
					<sec:authorize access="isAuthenticated()">
						...
						<li class="nav-item" id="infoPage"><a class="nav-link active" href="/memberPage/infoPage" id="memberInfo"><i class="fas fa-address-card"></i>&nbsp;마이페이지</a></li>
			...
			<div class="mt-5" id="wrapper">
     			<div class="slider-wrapper theme-default">
         		  <div id="slider" class="nivoSlider">    
        		       ...
        		       <img src="/resources/nivo-slider/demo/images/4.jpg" data-thumb="/resources/nivo-slider/demo/images/4.jpg" alt=""/>
        		       <img src="/resources/nivo-slider/demo/images/5.jpg" data-thumb="/resources/nivo-slider/demo/images/5.jpg" alt=""/>
        		       <img src="/resources/nivo-slider/demo/images/6.jpg" data-thumb="/resources/nivo-slider/demo/images/6.jpg" alt=""/>
      		     </div>
   		 	   </div>
  		 	</div>
		</div>
