...
<div class="row " align=center>
	...
	<div class="col-md-8 p-5 my-5"
		style="border: 1px solid skyblue; border-radius: 20px;">

		<div class="text-center mb-5">
			<button type="button" class="btn btn-outline-primary"
				style="width: 400px; height: 50px; font-family: 'Jua'; font-size: 2.0em;"
				disabled>회원 정보</button>
		</div>
